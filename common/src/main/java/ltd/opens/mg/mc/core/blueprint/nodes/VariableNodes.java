...
public class VariableNodes {
    ...
    public static void register() {
        ...
        NodeHelper.setup("float", "node.mgmc.float.name")
            ...
            .description("node.mgmc.float.desc")
        ...
        NodeHelper.setup("int", "node.mgmc.int.name")
            ...
            .color(NodeThemes.COLOR_NODE_VARIABLE)
            .description("node.mgmc.int.desc")
        ...
        NodeHelper.setup("boolean", "node.mgmc.boolean.name")
            ...
            .color(NodeThemes.COLOR_NODE_VARIABLE)
            .description("node.mgmc.boolean.desc")
        ...
        NodeHelper.setup("string", "node.mgmc.string.name")
            ...
            .color(NodeThemes.COLOR_NODE_VARIABLE)
            .description("node.mgmc.string.desc")
        ...
        NodeHelper.setup("get_variable", "node.mgmc.get_variable.name")
            .category("node_category.mgmc.variable")
            .color(NodeThemes.COLOR_NODE_VARIABLE)
            .description("node.mgmc.get_variable.desc")
            .property("web_url", "http://zhcn-docs.mc.maingraph.nb6.ltd/nodes/variable/get_variable")
        ...
        NodeHelper.setup("set_variable", "node.mgmc.set_variable.name")
            .category("node_category.mgmc.variable")
            .color(NodeThemes.COLOR_NODE_VARIABLE)
            .description("node.mgmc.set_variable.desc")
            .property("web_url", "http://zhcn-docs.mc.maingraph.nb6.ltd/nodes/variable/set_variable")
            .execIn()
            .execOut()
            .input(NodePorts.NAME, "node.mgmc.port.name", NodeDefinition.PortType.STRING, NodeThemes.COLOR_PORT_STRING, "")
        ...
        NodeHelper.setup("get_global_variable", "node.mgmc.get_global_variable.name")
            .category("node_category.mgmc.variable")
            .color(NodeThemes.COLOR_NODE_VARIABLE)
            .description("node.mgmc.get_global_variable.desc")
            .property("web_url", "http://zhcn-docs.mc.maingraph.nb6.ltd/nodes/variable/get_global_variable")
            .input(NodePorts.NAME, "node.mgmc.port.name", NodeDefinition.PortType.STRING, NodeThemes.COLOR_PORT_STRING, "")
            .output(NodePorts.VALUE, "node.mgmc.port.value", NodeDefinition.PortType.ANY, NodeThemes.COLOR_PORT_ANY)
            .registerValue((node, portId, ctx) -> {
                String name = TypeConverter.toString(NodeLogicRegistry.evaluateInput(node, NodePorts.NAME, ctx), ctx);
        ...
        NodeHelper.setup("set_global_variable", "node.mgmc.set_global_variable.name")
            .category("node_category.mgmc.variable")
            .color(NodeThemes.COLOR_NODE_VARIABLE)
            .description("node.mgmc.set_global_variable.desc")
            .property("web_url", "http://zhcn-docs.mc.maingraph.nb6.ltd/nodes/variable/set_global_variable")
            .execIn()
            .execOut()
            .input(NodePorts.NAME, "node.mgmc.port.name", NodeDefinition.PortType.STRING, NodeThemes.COLOR_PORT_STRING, "")
            .input(NodePorts.VALUE, "node.mgmc.port.value", NodeDefinition.PortType.ANY, NodeThemes.COLOR_PORT_ANY)
        ...
        NodeHelper.setup("get_entity_variable", "node.mgmc.get_entity_variable.name")
            .category("node_category.mgmc.variable")
            .color(NodeThemes.COLOR_NODE_VARIABLE)
            .description("node.mgmc.get_entity_variable.desc")
            .property("web_url", "http://zhcn-docs.mc.maingraph.nb6.ltd/nodes/variable/get_entity_variable")
        ...
        NodeHelper.setup("set_entity_variable", "node.mgmc.set_entity_variable.name")
            .category("node_category.mgmc.variable")
            .color(NodeThemes.COLOR_NODE_VARIABLE)
            .description("node.mgmc.set_entity_variable.desc")
            .property("web_url", "http://zhcn-docs.mc.maingraph.nb6.ltd/nodes/variable/set_entity_variable")
            .execIn()
            .execOut()
            .input(NodePorts.ENTITY, "node.mgmc.port.entity", NodeDefinition.PortType.ENTITY, NodeThemes.COLOR_PORT_ENTITY)
            .input(NodePorts.NAME, "node.mgmc.port.name", NodeDefinition.PortType.STRING, NodeThemes.COLOR_PORT_STRING, "")
