...
public class NodeHelper {
    ...
    public void registerEvent(
            ltd.opens.mg.mc.core.blueprint.events.MGMCEventType eventType,
            java.util.function.BiConsumer<ltd.opens.mg.mc.core.blueprint.events.MGMCEventContext, ltd.opens.mg.mc.core.blueprint.engine.NodeContext.Builder> contextPopulator,
            java.util.function.Function<ltd.opens.mg.mc.core.blueprint.events.MGMCEventContext, String> routingIdExtractor,
    ...
    public void registerEvent(
            ...
            java.util.function.BiConsumer<ltd.opens.mg.mc.core.blueprint.events.MGMCEventContext, ltd.opens.mg.mc.core.blueprint.engine.NodeContext.Builder> contextPopulator,
            SimpleValueHandler valueHandler) {
        registerEvent(eventType, contextPopulator, e -> ltd.opens.mg.mc.core.blueprint.routing.BlueprintRouter.GLOBAL_ID, valueHandler);
    }
