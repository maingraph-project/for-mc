...
![8d2cef9d-e1c1-455b-acc3-677b468256a7.png](https://free.picui.cn/free/2026/01/02/6957eb41247b6.png)
...
- 如果是，则播放粒子 `minecraft:happy_villager` 到触发者的位置，通过[[播放粒子效果]]。并且通过[[打印到聊天栏]]打印[[链接字符串]]：`你想说：{获取参数索引 0}。但，你好{变量 name}` 。
